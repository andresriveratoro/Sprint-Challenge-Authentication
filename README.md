...
HTTP is a stateless protocol, so sessions are one way to persist data such as authentication for new requests.  

2. What does bcrypt do to help us store passwords in a secure manner.  
Bcrypt helps us store passwords in a secure manner by transforming plain text passwords into a cryptographic hash.

3. What does bcrypt do to slow down attackers?  
It iterates through the hashing function several times.
